    ...
    <div className="animate-fade-in">
          ...
          <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2">
            <div>
              <div className="reveal">
                <p className="mb-3 text-sm font-medium tracking-wide uppercase text-fire-700">DB Infotech Fire & Industrial Safety</p>
              ...
              <div className="mb-8 space-y-4 leading-relaxed text-gray-600 reveal" style={{ transitionDelay: '0.15s' }}>
                ...
                <p>DB Infotech's Fire & Industrial Safety division combines decades of on-ground experience with modern automation to build safety infrastructure that organizations can rely on — consistently and confidently.</p>
              </div>
      ...
      <Section id="about" headline="Rooted in experience. Evolved for the future." bg="white" accentColor="fire">
        <div className="grid grid-cols-1 gap-8 mb-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <p className="mb-4 leading-relaxed text-gray-600">DB Infotech's Fire & Industrial Safety division has evolved from the legacy of S.B Fire & Safety — carrying forward years of on-ground expertise in fire protection, industrial safety, and regulatory compliance.</p>
      ...
      <Section id="contact" headline="Plan for safety today." subtitle="Whether you need an audit, a consultation, or a complete safety system design — reach out and we'll respond promptly." bg="gray" accentColor="fire">
        <div className="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-3">
          <TiltCard max={8}>
            <a href="mailto:safety@dbi.co.in" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover">
              ...
              <div className="mt-1 text-xs text-gray-500">safety@dbi.co.in</div>
            </a>
          </TiltCard>
          <TiltCard max={8}>
            <a href="tel:+919999999999" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover">
          ...
          <TiltCard max={8}>
            <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover">
