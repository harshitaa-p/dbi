...
const clients = [
  'Delta', 'MIT ADT University', 'Bhairav', 'Progress Builders & Developers',
  'Shah Group', 'Bhagwati Group', 'Balaji Group', 'Raheja',
  'Indian Oil', 'Kukreja Group Hotels', 'Little Words Project', 'Ansari Brothers',
  'Toll', 'Reliable Builders', 'Vista Group', 'Safal Group',
]
...
function ImageSlider({ images, height = 'h-[500px]' }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-fire-100">
      <div
      ...
      >
        {images.map((img) => (
          <img
            ...
            src={img.src}
            alt={img.alt}
            className={`w-full ${height} object-cover shrink-0`}
          />
        ))}
      </div>
      <button onClick={prev} className="absolute left-3 top-1/2 -translate-y-1/2 w-9 h-9 flex items-center justify-center rounded-full bg-white/80 backdrop-blur-sm text-gray-700 hover:bg-white shadow transition">
      ...
      <button onClick={next} className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 flex items-center justify-center rounded-full bg-white/80 backdrop-blur-sm text-gray-700 hover:bg-white shadow transition">
...
export default function FireAndSafety() {
  ...
  return (
    <div className="animate-fade-in">
              ...
              <div className="mb-8 space-y-4 leading-relaxed text-gray-600 reveal" style={{ transitionDelay: '0.15s' }}>
                ...
                <div className="flex flex-wrap gap-3 mt-4">
                  {serviceHighlights.map((s) => (
                    <span key={s.title} className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium bg-white rounded-full border border-fire-100 text-fire-800 shadow-sm">
            ...
            <div className="hidden lg:block reveal-right">
              <TiltCard max={8} scale={1.03}>
                <div className="overflow-hidden relative rounded-2xl border shadow-xl border-fire-100 glow-fire img-zoom">
                  <img src={px(2030190, 800)} alt="Fire safety professionals" className="w-full h-[480px] object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t to-transparent from-fire-900/40" />
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="px-4 py-3 bg-white/90 rounded-xl backdrop-blur-sm">
      ...
      {/* About Us */}
      <Section id="about" headline="About S. B. Fire Safety Services" subtitle="An ISO 9001 certified organization established in 2008 — a pioneer in the firefighting industry in India." bg="white" accentColor="fire">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <p className="mb-4 leading-relaxed text-gray-600">
              We are pleased to introduce S B Fire Safety Services. We provide complete solutions for all fire and safety requirements. Our mission is to spread awareness about fire safety, understand the safety requirements of clients, and deliver effective solutions.
            </p>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          {['High Quality Products', 'Professional Services', 'Timely Completion', 'Customer-friendly Support', 'Skilled Professionals'].map((item) => (
            <TiltCard key={item} max={6}>
              <div className="p-6 text-center bg-white rounded-xl border border-gray-100 card-hover h-full flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 gap-6 mb-10 sm:grid-cols-2 lg:grid-cols-3">
          {strengths.map((s, i) => (
            <TiltCard key={s.title} max={5}>
              <div className="p-6 h-full bg-fire-50 rounded-xl border border-fire-100 card-hover">
      ...
      <Section headline="Fire Extinguisher Supply & Refilling" subtitle="We provide supply, installation, testing, and refilling of all fire extinguishers. All products are ISI certified." bg="gray" accentColor="fire">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            ...
            <div className="p-4 bg-fire-50 rounded-xl border border-fire-100">
      ...
      <Section id="certifications" headline="Certifications & License" subtitle="Fully licensed and certified to deliver fire safety solutions across Maharashtra and India." bg="white" accentColor="fire">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <TiltCard max={5}>
            <div className="p-8 h-full bg-gradient-to-br rounded-xl border from-fire-50 to-orange-50 border-fire-200">
              ...
              <div className="mt-4 pt-4 border-t border-fire-200">
                <p className="text-xs font-semibold text-gray-700 mb-2">Authorized for:</p>
                <div className="flex flex-wrap gap-2">
          ...
          <TiltCard max={5}>
            <div className="p-8 h-full bg-gradient-to-br rounded-xl border from-gray-50 to-fire-50 border-gray-200">
              <div className="flex gap-3 items-center mb-4">
                <div className="flex justify-center items-center w-12 h-12 rounded-xl bg-gray-100">
              ...
              <div className="space-y-2">
                <p className="text-xs font-semibold text-gray-700 mb-2">Scope:</p>
          ...
          {clients.map((client) => (
            <TiltCard key={client} max={6}>
              <div className="flex items-center justify-center p-5 h-full bg-gray-50 rounded-xl border border-gray-100 card-hover hover:border-fire-200 min-h-[80px]">
                <p className="text-sm font-semibold text-center text-gray-700">{client}</p>
              </div>
            </TiltCard>
          ))}
        </div>
      ...
      <Section id="contact" headline="Contact Us" subtitle="Whether you need an audit, consultation, or complete fire safety system — reach out and we'll respond promptly." bg="gray" accentColor="fire">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div className="p-6 bg-gradient-to-br rounded-xl border from-fire-50 to-orange-50 border-fire-200 h-full">
          ...
          <div className="grid grid-cols-1 gap-4 lg:col-span-3 sm:grid-cols-3">
            <TiltCard max={8}>
              <a href="mailto:safety@sbfiresafety.com" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover h-full">
            ...
            <TiltCard max={8}>
              <a href="tel:+919999999999" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover h-full">
            ...
            <TiltCard max={8}>
              <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover h-full">
