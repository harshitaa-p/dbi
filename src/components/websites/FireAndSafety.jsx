        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <p className="mb-4 leading-relaxed text-gray-600">
              We are pleased to introduce D.B. Fire & Safety Services. We provide complete solutions for all fire and safety requirements. Our mission is to spread awareness about fire safety, understand the safety requirements of clients, and deliver effective solutions.
            </p>
      ...
      <Section id="contact" headline="Contact Us" subtitle="Whether you need an audit, consultation, or complete fire safety system reach out and we'll respond promptly." bg="gray" accentColor="fire">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          ...
          <div className="grid grid-cols-1 gap-4 lg:col-span-3 sm:grid-cols-3">
            ...
            <TiltCard max={8}>
              <a href="tel:+917021970004" className="block p-6 h-full text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-fire-hover">
