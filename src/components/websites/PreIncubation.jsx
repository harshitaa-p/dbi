          ...
          <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2">
            <div>
              ...
              <div className="mb-8 space-y-4 leading-relaxed text-gray-600 reveal" style={{ transitionDelay: '0.15s' }}>
                ...
                <p>
                  The D.B. Infotech Pre-Incubation Center exists to bridge this gap. We help students and institutions build structured environments where ideas can be explored, refined, and transformed into working prototypes.
                </p>
              </div>
