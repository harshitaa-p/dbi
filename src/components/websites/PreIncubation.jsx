    ...
    <div className="animate-fade-in">
      ...
      <Section id="contact" headline="Let's start a conversation." subtitle="Whether you're a student with an idea, an institution looking to build innovation capacity, or a partner interested in collaboration — we'd like to hear from you." bg="gray">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <TiltCard max={8}>
            <a href="tel:+919922919565" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-primary-hover">
          ...
          <TiltCard max={8}>
            <a href="https://wa.me/919922919565" target="_blank" rel="noopener noreferrer" className="block p-6 text-center bg-white rounded-xl border border-gray-100 transition-all duration-500 card-hover group glow-primary-hover">
      ...
      <div className="py-16 text-center bg-gradient-to-br via-white to-blue-50 from-primary-50">
